...
//    public static  String PASSWORD;// = "poiulkjh123";
    ...
    public static final String CREATE_DATABASE = "CREATE DATABASE IF NOT EXISTS aug20";
    //public static final String DATABASE = "cursuri";
    public static String URL = String.format( "jdbc:mysql://localhost:3306/%s?useLegacyDateTimeCode=false&serverTimezone=GMT", "aug20" );
    ...
    public static final String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS personal_aug20 (marca INT(7) AUTO_INCREMENT PRIMARY KEY, cnp VARCHAR(14),nume VARCHAR(300), dataNasterii DATE, dataAngajarii DATE, vechimea INT(2),salariuBrut VARCHAR(10),salNet INTEGER(6),cas INTEGER(6), cass INTEGER(6), impozit INTEGER(5), stare VARCHAR(10)";
    //public static final String USE_TABLE = "USE personal";
    public static final String USE_TABLE = "USE personal_aug20";
    ...
    public Integer getVechimea () {
        return vechimea;
    }

    public String getSalariuBrut () {
        return salariuBrut.get();
    }
    ...
    public Integer getCass () {
        return cass;
    }

    public Integer getImpozit () {
        return impozit;
    }

    public Integer getSalNet () {
        return salNet;
    }
    ...
    public SimpleStringProperty salariuBrutProperty () {
        return salariuBrut;
    }

    public SimpleStringProperty stareProperty () {
        return stare;
    }
    ...
    public void setCass ( Integer cass ) {
        this.cass = cass;
    }

    public void setImpozit ( Integer impozit ) {
        this.impozit = impozit;
    }

    public void setSalNet ( Integer salNet ) {
        this.salNet = salNet;
    }
